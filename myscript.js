...
/*
	...
	{
		let array2 = countryJSON.timezones;
		let output = "<strong>Live times</strong>: <br />";
		...
		if (array2[p] = "UTC+3:00") 
		{
				output += (today.getHours() + 10) + ":" + today.getMinutes() + ":" + today.getSeconds();
				
		} 
			
		if (array2[p] = "UTC+4:00") 
		{
				
				output += (today.getHours() + 11) + ":" + today.getMinutes() + ":" + today.getSeconds();
			
		}
		
		elemLiveTime.innerHTML = output;
		
		
	} else {
		elemLiveTime.innerHTML = "";
	}
*/
